Shader "Hidden/Sentis/Broadcast"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_local Add Sub Mul Div TruncDiv FloorDiv PowFloatFloat PowFloatInt Min Max Mod FMod Mean AddInt SubInt MulInt TruncDivInt FloorDivInt PowIntFloat PowIntInt MinInt MaxInt ModInt FModInt And Equal NotEqual Greater GreaterOrEqual Less LessOrEqual EqualInt NotEqualInt GreaterInt GreaterOrEqualInt LessInt LessOrEqualInt Or Xor PRelu BitwiseAnd BitwiseOr BitwiseXor Atan2
            ...
            #if defined(AddInt) | defined(SubInt) | defined(MulInt) | defined(TruncDivInt) | defined(FloorDivInt) | defined(MinInt) | defined(MaxInt) | defined(ModInt) | defined(FModInt) | defined(And) | defined(EqualInt) | defined(NotEqualInt) | defined(GreaterInt) | defined(GreaterOrEqualInt) | defined(LessInt) | defined(LessOrEqualInt) | defined(Or) | defined(Xor) | defined(PowIntInt) | defined(BitwiseAnd) | defined(BitwiseOr) | defined(BitwiseXor)
            #define O_DTYPE4 int4
            #define A_DTYPE4 int4
            #define B_DTYPE4 int4
            DECLARE_TENSOR(A, int);
            DECLARE_TENSOR(B, int);
            #elif defined(Equal) | defined(NotEqual) | defined(Greater) | defined(GreaterOrEqual) | defined(Less) | defined(LessOrEqual)
            #define O_DTYPE4 int4
            ...
            O_DTYPE4 frag(v2f i, UNITY_VPOS_TYPE screenPos : VPOS) : SV_Target
            {
                ...
                vb = DimAxisB == 1 ? vb.x : vb;
                ...
                #endif
                #ifdef FloorDivInt
                    v = (va / vb) - ((((va ^ vb) >> 31) & 1) & ((((va % vb) | -(va % vb)) >> 31) & 1));
                #endif
                    ...
                    v = ((va % vb) + vb) % vb;
                #endif
                #if defined(And) | defined(BitwiseAnd)
                    v = va & vb;
                #endif
                #if defined(Equal) | defined(EqualInt)
                    v = va == vb;
                #endif
                #if defined(NotEqual) | defined(NotEqualInt)
                    v = va != vb;
                #endif
                    ...
                    v = va <= vb;
                #endif
                #if defined(Or) | defined(BitwiseOr)
                    v = va | vb;
                #endif
                #if defined(Xor) | defined(BitwiseXor)
                    v = va ^ vb;
                #endif
                #ifdef PRelu
